...
function onMouseDown(e) {
    ...
    if (movable) {}
    else if (Terminal.mode === MODE.CODE) {
...
async function init() {
    ...
    moveButton.addEventListener('click', () => {
        if (!movable) moveButton.style.backgroundColor = 'pink'
        else moveButton.style.backgroundColor = 'rgb(' + 214 + ',' + 184 + ',' + 144 + ')'
        movable = !movable
    })
